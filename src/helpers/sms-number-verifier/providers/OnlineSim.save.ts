...
export default class OnlineSim extends Provider {
    ...
    public async getNumbers() {
        try {
            ...
            const URL_ONLINE_SIM = `https://onlinesim.ru/api/getNum.php?apikey=${OnlineSim.apiKey}&country=${OnlineSim.country}&service=Google&number=true`;
    ...
    public async getMessages(numberInfo: IReturn) {
        try {
            let smsCode = '';
            ...
            const URL_ONLINE_SIM = `https://onlinesim.ru/api/getState.php?apikey=${OnlineSim.apiKey}&tzid=${numberInfo.tzid}&message_to_code=1&form=1&msg_list=0`;
